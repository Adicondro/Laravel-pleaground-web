...
<body class="bg-gray-100 text-gray-900">
    ...
    <div class="container mx-auto p-6 max-w-lg">
        <h1 class="text-3xl font-extrabold mb-4 text-center text-indigo-600">Create Product</h1>

        <form action="/reminders" method="POST" class="bg-white p-6 rounded-lg shadow-md">
            @csrf
            <div class="mb-4">
                <label for="goals" class="block text-sm font-medium text-gray-700">Goals</label>
                <input type="text" name="goals" id="goals" class="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
            </div>
            <div class="mb-4">
                <label for="inspiration" class="block text-sm font-medium text-gray-700">Who Are You Inspired By</label>
                <input type="text" name="inspiration" id="inspiration" class="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
            </div>
            <div class="mb-4">
                <label for="smallest_move" class="block text-sm font-medium text-gray-700">What's your smallest move</label>
                <input type="text" name="smallest_move" id="smallest_move" class="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
            </div>
            <div class="mb-4">
                <label for="reward" class="block text-sm font-medium text-gray-700">What Reward You Wanna Get</label>
                <input type="text" name="reward" id="reward" class="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
            </div>
